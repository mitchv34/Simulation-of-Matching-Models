...
As \textbf{Figure \ref{fig:sim_omega_A}} shows if we set $\omega_A = 0.5$ we obtain a fully simetric model with equilibrium mathing $\mu(x) = x$ and all firms reching consants size $\mathcal{H}(x)=H$.
