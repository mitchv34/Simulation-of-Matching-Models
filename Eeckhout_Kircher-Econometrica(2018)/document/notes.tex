...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1\textwidth]{figures/plot_ω_A.pdf}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1\textwidth]{figures/plot_σ_A.pdf}
...
\begin{figure}[h]
    \begin{center}
        \includegraphics[width=1\textwidth]{figures/plot_ω_B.pdf}
