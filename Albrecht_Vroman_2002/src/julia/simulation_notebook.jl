...
# ╔═╡ 7d3c605b-ade8-4777-9f5f-f067e7ec2c6a
begin
	using NLsolve
	using Plots
end

# ╔═╡ 3e7733f8-d9ed-4d70-9651-40bf1b09d2ac


# ╔═╡ f93a09c3-bc26-4af1-a40a-7e43e0639c15
# Parameters
begin
	s₁ = 1;
	s₂ = 1.35;
...
# ╔═╡ a0ad9f9d-9b09-4069-a98a-bfa31f5d7202
function find_ES_equilibrium()
	...
	return θ_eq, m_θ_eq, u_eq, γ_eq, ϕ_eq
end

# ╔═╡ 9ab19dcb-1115-4ff8-bfcb-9fcee617760a
find_ES_equilibrium()
